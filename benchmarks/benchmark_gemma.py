...
def main():
    ...
    df.to_csv("benchmark_results_gemma.csv", index=False, encoding="utf-8-sig")
    systems = []
    ...
    summary_df.to_csv("benchmark_summary_gemma.csv", index=False, encoding="utf-8-sig")
    category_rows = []
    ...
    category_df.to_csv("benchmark_by_category_gemma.csv", index=False, encoding="utf-8-sig")
    difficulty_rows = []
    ...
    difficulty_df.to_csv("benchmark_by_difficulty_gemma.csv", index=False, encoding="utf-8-sig")
    print("\n" + "=" * 90)
    print("=== GENEL ÖZET ===")
    print(summary_df)
